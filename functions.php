...
function sandbox_scripts() {
	...
	wp_enqueue_style( 'sandbox-google-fonts', '//fonts.googleapis.com/css?family=Hind:400,700', false ); 

	wp_enqueue_style( 'sandbox-style', get_stylesheet_uri() );

	wp_enqueue_script( 'sandbox-navigation', get_template_directory_uri() . '/assets/js/vendor/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'sandbox-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/vendor/skip-link-focus-fix.js', array(), '20151215', true );

	wp_enqueue_script( 'sandbox-js', get_template_directory_uri() . '/js/custom/main.js', array( 'jquery' ), '1.0.0', true );
